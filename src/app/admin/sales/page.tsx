...
import { ShoppingBag, Search, Calendar, User, Phone, MapPin, CheckCircle2, Eye, X } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div>
        ...
        <p className="text-xs text-zinc-400">
          Registro completo de compras procesadas mediante Supabase RPC.
        </p>
      </div>
