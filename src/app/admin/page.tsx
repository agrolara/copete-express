...
import { INITIAL_SALES } from '@/lib/supabase';
import {
  DollarSign,
  TrendingUp,
  AlertTriangle,
...
export default function AdminDashboardPage() {
  ...
  // Manejo de la selección (tiqueado) de productos/promos
  ...
  // Procesar pedido manual del administrador
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="p-5 rounded-2xl bg-zinc-900/90 border border-zinc-800 flex items-center justify-between">
          <div>
            ...
            <span className="text-[10px] text-zinc-500 block mt-1">WhatsApp & Web</span>
          </div>
      ...
      {isOrderModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fade-in overflow-y-auto">
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-5 my-8">
            ...
            {generatedSummary ? (
              /* PANTALLA CON EL RESUMEN GENERADO Y OPCIONES DE ENVÍO A WHATSAPP */
              <div className="space-y-4 animate-fade-in">
                <div className="p-4 rounded-2xl bg-emerald-950/40 border border-emerald-500/40 text-emerald-300 text-xs flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-300">Usa las opciones abajo para enviar o reenviar el resumen al cliente por WhatsApp.</p>
                  </div>
                </div>

                {/* Previsualización del Texto Resumen */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {/* Opción 1: Enviar al WhatsApp propio del Admin para reenviar */}
                  <a
                  ...
                  {/* Opción 2: Enviar directo al WhatsApp del Cliente */}
                  <a
              ...
              /* FORMULARIO DE TIQUEADO DE PRODUCTOS Y SELECCIÓN DE PAGO */
              <form onSubmit={handleProcessAdminOrder} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-zinc-400">Incluye datos de cuenta automáticamente</span>
                      </div>
                    </label>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-zinc-400">Cobro contra entrega en domicilio</span>
                      </div>
                    </label>
                  </div>
                </div>

                {/* LISTA DE PRODUCTOS Y PROMOS CON CASILLA PARA TIQUEAR */}
                ...
                <div className="pt-3 border-t border-zinc-800 flex justify-end gap-3">
                  ...
                  >
                    <MessageSquare className="w-4 h-4" />
                    <span>Generar Resumen WhatsApp y Descontar Stock</span>
                  </button>
                </div>
              </form>
            )}
      ...
      {/* MODAL CONFIGURACIÓN WHATSAPP & DATOS BANCARIOS (SUPER ADMIN) */}
      {isSettingsOpen && (
